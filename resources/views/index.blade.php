    ...
    <body>
        <div class="content">
            <div class="row mt-5 ml-2">
                <div class="col-md-12"><h1>Phone Numbers</h1></div>
            </div>
            <div class="row mt-5 ml-2">
                <form class="form-inline" id="formFilter" method="GET" action="{{ route('customer.index') }}">
                    @csrf
                    @method('GET')
                    <div class="col-6">
                        <div class="form-group mb-2">
                            <select class="form-control" name="country" id="country">
                                ...
                                @foreach ($countries as $c)
                                    <option value="{{ $c[0] }}" {{ !empty($request->country) && $request->country == $c[0] ? 'selected' : '' }}>{{ $c[0] }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
            ...
            <div class="row mt-5 ml-2">
                <div class="col-md-8">
                    ...
                    <div class="rigth">{{ $customers->links() }}</div> 
                </div>
            </div>
        </div>
    </body>
